...
/**
 * Sample test cases from repo for EE360P course
 *
 * https://github.com/vijaygarg1/EE-360P/blob/master/hw1-template/q1/SimpleTest.java
 */
public class SampleTests {
    ...
    private static void verifyParallelSort(int[] A) {
